...
exports.kvRouter.post('/kv/write', (req, res) => {
    const sqlite = (0, sqlite_1.getSqlite)();
    if (!sqlite) {
        res.status(503).json({ ok: false, message: 'sqlite_not_configured' });
        return;
    ...
    if (pathKey === legacyKvPath_1.REPAIR_ORDERS_LEGACY_KV_PATH) {
